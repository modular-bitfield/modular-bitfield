...
fn main() {
    ...
    println!(
        "VariableData supported sizes: {:?}",
        VariableData::supported_sizes()
    );
    println!(
        "VariableData supported discriminants: {:?}",
        VariableData::supported_discriminants()
    );
    ...
    println!(
        "  VariableData::size_for_discriminant(0) == Some(8): {:?}",
        VariableData::size_for_discriminant(0)
    );
