...
enum UmpMessage {
    #[discriminant = 0]
    Utility32(u32),     // 32-bit message containing type 0 utility messages
    #[discriminant = 1]
    System32(u32),      // 32-bit message containing type 1 system messages
    #[discriminant = 3]
    SysEx64(u64),       // 64-bit message containing type 3 sysex messages
    #[discriminant = 5]
    SysEx8_128(u128),   // 128-bit message containing type 5 sysex8 messages
}
...
fn test_128bit_sysex8_in_1_ump_message() {
    ...
    let sysex_data = [0xF0, 0x43, 0x12, 0x15, 0x20, 0x25, 0x30, 0x35, 0x40, 0x45, 0x50, 0x55];
...
fn test_128bit_sysex8_start_message() {
    ...
    let sysex_data = [0xF0, 0x7E, 0x00, 0x06, 0x02, 0x41, 0x56, 0x00, 0x19, 0x00, 0x01, 0x00];
